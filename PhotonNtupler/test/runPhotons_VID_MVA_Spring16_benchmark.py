...
idSpecification = cms.PSet(
    ...
    phoIdBoolMap = cms.InputTag("egmPhotonIDs:mvaPhoID-Spring16-nonTrig-V1-wp90"),
    phoIdFullInfoMap = cms.InputTag("egmPhotonIDs:mvaPhoID-Spring16-nonTrig-V1-wp90"),
    phoIdVerbose = cms.bool(False),
    #
    # ValueMaps with MVA results
    #
    mvaValuesMap     = cms.InputTag("photonMVAValueMapProducer:PhotonMVAEstimatorRun2Spring16NonTrigV1Values"),
    mvaCategoriesMap = cms.InputTag("photonMVAValueMapProducer:PhotonMVAEstimatorRun2Spring16NonTrigV1Categories")
)

idName = "egmPhotonIDs:mvaPhoID-Spring16-nonTrig-V1-wp90"
idSpecification.phoIdBoolMap = cms.InputTag(idName)
idSpecification.phoFullInfoMap = cms.InputTag(idName)
process.ntuplerWP90 = cms.EDAnalyzer(
    'PhotonNtuplerVIDwithMVADemo',
    commonParameters,
    idSpecification
    )

idName = "egmPhotonIDs:mvaPhoID-Spring16-nonTrig-V1-wp80"
idSpecification.phoIdBoolMap = cms.InputTag(idName)
idSpecification.phoFullInfoMap = cms.InputTag(idName)
process.ntuplerWP80 = cms.EDAnalyzer(
    'PhotonNtuplerVIDwithMVADemo',
    commonParameters,
    idSpecification
    )
...
process.p = cms.Path(process.egmPhotonIDSequence * process.ntuplerWP90 * process.ntuplerWP80)
