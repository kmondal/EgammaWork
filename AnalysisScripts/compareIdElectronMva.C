...
const TString fileNames[nSamples] = {"DYJetsToLL_mvaID_80X_small_v1.root",
				     "DYJetsToLL_mvaID_90X_small_v1.root",
				     "TTJets_mvaID_80X_small_v1.root",
				     "TTJets_mvaID_90X_small_v1.root"};
