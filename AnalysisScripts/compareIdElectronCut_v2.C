...
const TString fileNames[nSamples] = {"DYJetsToLL_cutID_80X_small_v2.root",
				     "DYJetsToLL_cutID_90X_small_v2.root",
				     "TTJets_cutID_80X_small_v2.root",
				     "TTJets_cutID_90X_small_v2.root"};
